...
class BrandColors {
  ...
  static const Color colorPrimary = Color(0xFF254081);
  static const Color colorPrimaryLight = Color(0xFF7794DB);
  ...
  static const Color colorCampanha = Color(0xFF023E84);
